<?php 
  $namePage = 'БЛОГ Список'; // название страницы
              ...
              <section class="pagelist-item clear">
                ...
                <div class="pagelist-item-content all-pagelist-item-content pagelist-item-content col-xl-7 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="pagelist-info full-pagelist-info">
                    <a href="#" class="author"><img src="app/img/content/author.jpg" alt="Автор" title="Автор"></a>
                    <span class="pagelist__author"><a href="#">Киномания</a></span>, 
                    <span class="all-post__author"><a href="#">Все посты автора</a></span>
