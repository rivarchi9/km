...
<?php 
  $namePage = 'Компании'; // название страницы
      ...
      <div class="main-content-other-page clear">
        ...
        <section class=" outer-section clear outer-content">
          ...
          <content class="page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
          	<h1 class="pagetitle mini__pagetitle company-pagetitle">Gaijin Entertainment (студия)</h1>
            <div class="page-content-head clear page-content-head-company">
              <div class="page-content-head__image">
                <div class="image-shadow ">
                  <div class="image-cover"><img src="app/img/content/gj.jpg" alt="" class=""></div>
                </div>
                <div class="company-link">
                  <a href="http://gaijin.ru/" target="blank">http://gaijin.ru/</a>
                </div>
              </div>
              <div class="page-content-head__content">
                <div class="page-content-head__content-text">
                  <p><b>Gaijin Entertainment</b> – крупнейший независимый разработчик игр
                    в России. Компания основана в 2002 году и сегодня Gaijin Entertainment – это свыше 150 высококвалифицированных специалистов в нескольких городах в России и Европе.</p>
                  <p>Gaijin Entertainment создала уже более 30 игр для разнообразных платформ – PC, PlayStation 4, PlayStation 3, Xbox 360, iOS и Android. Они завоевали множество наград от прессы и представителей игровой индустрии, а также заняли первые места на церемонии КРИ Awards
                    в таких номинациях как «Лучшая игра-симулятор», «Лучший игра
                    в жанре action», «Лучшая игровая графика», «Лучшая мобильная игра», «Лучшая технология», «Лучший звук» и «Лучшая компания-разработчик». Созданная Gaijin Entertainment игра «Ил-2:</p>
                </div>
                <div class="page-content-head__more">
                <a href="#" class="list-about-item__button animated">Читать полностью</a>
                </div>
              </div>
            </div>
                ...
                <div class="shadow-list-about">
                  <div class="list-about-item clear" data-type-openclose-button="1">
                    <div class="list-about-item-tile">
                      <span class="list-about-item__title animated">УЧАСТИЕ В ПРОИЗВОДСТВЕ</span>
                      <span class="list-about-item__number">1</span>
                    </div>
                      ...
                      <div class="row-chief-title clear">
                        ...
                        <div class="section-result-item section-result-item-actor">
                          <div class="list-preview">
                            <a href="#">
                              <span>
                                <img class=" image-padding--white" src="app/img/content/gp.jpg" alt="">
                              </span>
                            </a>
                          </div>
                        </div>
