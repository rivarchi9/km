<?php
  $namePage = 'Фото Актера'; // название страницы
        ...
        <div class="head-content">
          ...
          <div class="nav-content">
            <ul class="nav-content-list clear">
              ...
              <li class="nav-content-item active"><a href="actor_photo.php">Фото <span class="number">45</span></a></li>
              ...
              <div class="row">
                <div class="posters-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="posters-caption">
                    <span class="posters-caption__screen">596x600</span>,<span class="posters-caption__size">56 КБ</span>
                  </div>
                </div>
                <div class="posters-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                  <div class="row-posters__image">
