...
<?php
  $namePage = 'Соундтреки'; // название страницы
      ...
      <div class="main-content-other-page clear">
        ...
        <section class=" outer-section clear outer-content">
          ...
          <content class="page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
          	<h1 class="pagetitle trailers-pagetitle">ВСЕ Соундтреки</h1>
            ...
            <div class="scripts-list-item">
              ...
              <div class="row-posters posters--hover">
                <div class="row row-tile-block">
                    ...
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/st1.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st1.jpg" data-src-t="app/img/content/st1.jpg" data-src-m="">
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="posters-item posters-item-tile">
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/st2.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st2.jpg" data-src-t="app/img/content/st2.jpg" data-src-m="">
                        </div>
                      </a>
                    </div>
                    <div class="posters-caption">
                  ...
                  <div class="posters-item posters-item-tile">
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/st3.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st3.jpg" data-src-t="app/img/content/st3.jpg" data-src-m="">
                        </div>
                      </a>
                    </div>
                    <div class="posters-caption">
