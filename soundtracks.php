...
<?php
  $namePage = 'Саундтреки'; // название страницы
        ...
        <section class=" outer-section clear outer-content">
          ...
          <content class="page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="row-soundtracks">
              <h1 class="pagetitle trailers-pagetitle">ВСЕ Саундтреки</h1>
              ...
              <div class="row-mini-slide row-mini-slide--two row-mini-slide--gray">
                ...
                <div class="row-bx-mini-slider">
                  <div class="bx-mini-slider bx-mini-slider-posters posters--hover">
                    <div class="slide"><a href="#" class=""><img src="app/img/content/po5.jpg"></a>
                      <div class="bx-mini-slider-caption">
                        <div class="poster-title"><a href="#">Криминальное чтиво</a></div>
                        <div class="poster-title-eng">Криминальное чтиво</div>
                      </div>
                    </div>
                    <div class="slide"><a href="#" class=""><img src="app/img/content/po5.jpg"></a>
                      <div class="bx-mini-slider-caption">
                  ...
                  <div class="row row-tile-block">
                      ...
                      <div class="row-posters__image">
                        <a href="#">
                          <div class="image-shadow-poster posters__image">
                            <img alt="" src="app/img/content/st1.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st1.jpg" data-src-t="app/img/content/st1.jpg" data-src-m="app/img/content/st1.jpg">
                          </div>
                        </a>
                      </div>
                      <div class="posters-caption">
                        <div class="poster-title"><a href="#">Отрицание</a></div>
                        <div class="poster-title-eng">Denial</div>
                      </div>
                    </div>
                    <div class="posters-item posters-item-tile">
                      <div class="row-posters__image">
                        <a href="#">
                          <div class="image-shadow-poster posters__image">
                            <img alt="" src="app/img/content/st2.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st2.jpg" data-src-t="app/img/content/st2.jpg" data-src-m="app/img/content/st1.jpg">
                          </div>
                        </a>
                      </div>
                      <div class="posters-caption">
                    ...
                    <div class="posters-item posters-item-tile">
                      <div class="row-posters__image">
                        <a href="#">
                          <div class="image-shadow-poster posters__image">
                            <img alt="" src="app/img/content/st3.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/st3.jpg" data-src-t="app/img/content/st3.jpg" data-src-m="app/img/content/st1.jpg">
                          </div>
                        </a>
                      </div>
                      <div class="posters-caption">
