<ul class="nav-content-list clear nav-content-list-actor">
    ...
    <ul class="result-list">
      <li class="nav-content-item default"><a href="actor.php">Фильмография</a></li>
      ...
      <li class="nav-content-item default"><a href="actor_box.php">Кадры <span class="number">616</span></a></li>
		  <li class="nav-content-item default"><a href="actor_posters.php">Постеры <span class="number">616</span></a></li>
		  ...
		  <li class="nav-content-item-add default"><a href="actor_news.php">Видео <span class="number">22</span></a></li>
    </ul>
  </div>
  ...
  <li class="nav-content-item"><a href="actor_posters.php">Постеры <span class="number">616</span></a></li>
  ...
  <li class="nav-content-item"><a href="actor_trailers.php">Видео <span class="number">22</span></a></li>
</ul>