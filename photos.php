...
<?php
  $namePage = 'Фото'; // название страницы
            ...
            <div class="row-mini-slide row-mini-slide--two row-posters-mini-slide  row-mini-slide--gray">
              ...
              <div class="row-bx-mini-slider">
                <div class="bx-mini-slider bx-mini-slider-posters posters--hover">
                  <div class="slide"><a href="#" class=""><img src="app/img/content/ph1.jpg"></a>
                    <div class="bx-mini-slider-caption">
                      <div class="poster-title"><a href="#">Натали Портман</a></div>
                      <div class="poster-title-eng">Natalie Portman</div>
                      <div class="poster-number"><span class="value">177</span> шт.</div>
                    </div>
                  </div>
                  <div class="slide"><a href="#" class=""><img src="app/img/content/ph1.jpg"></a>
                    <div class="bx-mini-slider-caption">
                ...
                <div class="row row-tile-block">
                    ...
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/ph2.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/ph2.jpg" data-src-t="app/img/content/ph2.jpg" data-src-m="app/img/content/ph4.jpg">
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="posters-item posters-item-tile">
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/ph3.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/ph3.jpg" data-src-t="app/img/content/ph3.jpg" data-src-m="app/img/content/ph4.jpg">
                        </div>
                      </a>
                    </div>
                    <div class="posters-caption">
                      <div class="poster-title"><a href="#">Алессандра де Росси</a></div>
                      <div class="poster-title-eng">Alessandra de Rossi</div>
                      <div class="poster-number"><span class="value">6</span> шт.</div>
                    </div>
                  </div>
                  <div class="posters-item posters-item-tile">
                    <div class="row-posters__image">
                      <a href="#">
                        <div class="image-shadow-poster posters__image">
                          <img alt="" src="app/img/content/ph4.jpg" class="parent responsive-image image-prewiew" data-src-d="app/img/content/ph4.jpg" data-src-t="app/img/content/ph4.jpg" data-src-m="app/img/content/ph4.jpg">
                        </div>
                      </a>
                    </div>
                    <div class="posters-caption">
                      <div class="poster-title"><a href="#">Белый король</a></div>
                      <div class="poster-title-eng">The White King</div>
                      <div class="poster-number"><span class="value">6</span> шт.</div>
                    </div>
                  </div>
                  <div class="posters-item posters-item-tile">
