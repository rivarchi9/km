<?php
  $namePage = 'Обои Актера'; // название страницы
...
<body>
  ...
  <div class="desc-in-over">
    <span class="desc"></span><a class="link" href="">Скачать</a>
  </div>
        ...
        <div class="head-content">
          ...
          <div class="nav-content">
            <ul class="nav-content-list clear">
              ...
              <li class="nav-content-item active"><a href="actor_wall.php">Обои <span class="number">11</span></a></li>
                ...
                <div class="wall-content">
                  <div class="wall-size-item">
                    ...
                    <ul class="wall-size-list">
                      <li data-type-over-img="http://www.zooclub.ru/skat/img.php?w=700&h=700&img=./attach/12000/12669.jpg" data-type-over-desc=".desc-in-over" data-type-over-desc-desc="Lorem ipsum">
                        <a class="parent">1600x1200</a>
                      </li>
                      <li data-type-over-img="http://www.fonstola.ru/pic/201111/2560x1600/fonstola.ru-60717.jpg"><a class="parent">1280x980</a></li>
                      <li data-type-over-img=""><a class="parent">1024x768</a></li>
                      <li data-type-over-img=""><a class="parent">800x600</a></li>
                    </ul>
                  </div>
                  <div class="wall-size-item">
                    <div class="wall-size" data-type="">16x10</div>
                    <ul class="wall-size-list">
                      <li data-type-over-img=""><a class="parent">1920x1200</a></li>
                      <li data-type-over-img="" class="active open-help-in"><a class="parent">1680x1050</a>
                        <div class="help help--color2">Ваше разрешение</div>
                      </li>
                      <li data-type-over-img=""><a class="parent">1440x900</a></li>
                      <li data-type-over-img=""><a class="parent">1280x800</a></li>
                      <li data-type-over-img=""><a class="parent">960x600</a></li>
                    </ul>
                  </div>
                  <div class="wall-size-item">
                    <div class="wall-size" data-type="">16x9</div>
                    <ul class="wall-size-list">
                      <li data-type-over-img=""><a class="parent">1920x1080</a></li>
                  ...
                  <div class="wall-size-item">
                    ...
                    <ul class="wall-size-list">
                      <li data-type-over-img=""><a class="parent">1280x1024</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="wall-items clear">
                ...
                <div class="wall-content">
                  <div class="wall-size-item">
                    <div class="wall-size" data-type="">4x3</div>
                    <ul class="wall-size-list">
                      <li data-type-over-img=""><a class="parent">1600x1200</a></li>
                      <li data-type-over-img=""><a class="parent">1280x980</a></li>
                      <li data-type-over-img=""><a class="parent">1024x768</a></li>
                      <li data-type-over-img=""><a class="parent">800x600</a></li>
                    </ul>
                  </div>
                  <div class="wall-size-item">
                    ...
                    <ul class="wall-size-list">
                      <li data-type-over-img=""><a class="parent">1920x1200</a></li>
                      <li data-type-over-img=""><a class="parent">1680x1050</a></li>
                      <li data-type-over-img="" class="active open-help-in"><a class="parent">1440x900</a>
                        <div class="help help--color2">Ваше разрешение</div>
                      </li>
                      <li data-type-over-img=""><a class="parent">1280x800</a></li>
                      <li data-type-over-img=""><a class="parent">960x600</a></li>
